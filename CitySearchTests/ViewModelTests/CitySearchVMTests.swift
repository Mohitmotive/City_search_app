...
class CitySearchVMTests: XCTestCase {
    ...
    var viewModel: CitySearchVM!
    
    override func setUp() {
        super.setUp()
        viewModel = CitySearchVM(networkService: NetworkService())
    }
    ...
    func testFetchCitiesWithQuery() {
        ...
        XCTAssertEqual(firstCity.topographicalName, "Berlin")
